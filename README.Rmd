...
* Analysis functions: `compute_abundance`, `comparison_matrix`, others `separate_quant_matrices`
* Utility functions
...
- [ ] Add support for multi-quantification matrices to several functions

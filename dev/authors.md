...
- **Francesco Gazzo**. Maintainer.
  [](https://orcid.org/0009-0000-4626-1386)

- **Giulia Pais**. Author. [](https://orcid.org/0009-0005-5621-4803)
...
Source:
[`inst/CITATION`](https://github.com/calabrialab/ISAnalytics/blob/devel/inst/CITATION)
...
https://github.com/calabrialab/ISAnalytics - R package version 1.23.2,
<http://www.bioconductor.org/packages/ISAnalytics>.
    ...
    @Manual{,
      ...
      note = {https://github.com/calabrialab/ISAnalytics - R package version 1.23.2},

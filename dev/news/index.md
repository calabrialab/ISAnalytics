...
- [`remove_collisions()`](https://calabrialab.github.io/ISAnalytics/dev/reference/remove_collisions.md)
  now resolves collisions by first comparing relative integration-site
  abundance across independent samples. Abundance is measured with the
  sequence count column selected through `quant_cols["seqCount"]`,
  summed within each independent sample.

...
test_that(".eval_tag_duplicates ok with custom tag politic", {
  ...
  politics <- c("project_id" = "error", "pcr_replicate" = "error",
                "tp_days" = "keep")
  expect_error({
    res <- .eval_tag_duplicates(tmp_specs, duplicate_politic = politics)
  }, class = "tag_dupl_err")

  politics <- c("project_id" = "first", "pcr_replicate" = "error",
                "tp_days" = "keep")
...
test_that(".eval_tag_types works as expected", {
  ...
  types_specs <- c("project_id" = "char", "pcr_replicate" = "int",
                   "tp_days" = "char")
  expected_out <- tibble::tribble(
    ~ names, ~ types, ~ transform, ~ flag, ~ tag,
    "var3", "int", NULL, "required", "pcr_replicate",
  ...
  types_specs <- c("project_id" = "int", "pcr_replicate" = "int",
                   "tp_days" = "char")
  expect_error({
    result <- .eval_tag_types(df = tmp_specs, types = types_specs)
  }, class = "tag_type_err")
...
test_that(".check_required_cols errors for missing tags", {
  ...
  expect_error({
    result <- .check_required_cols(required_tags = req_tags,
                                   vars_df = tmp_specs,
...
test_that(".check_required_cols errors for duplicates", {
  ...
  custom_politic <- c("project_id" = "error",
                      "pcr_replicate" = "first",
                      "tp_days" = "keep")
  expect_error({
    result <- .check_required_cols(required_tags = req_tags,
  ...
  req_tags <- c("project_id" = "char", "pcr_replicate" = "int",
                "tp_days" = "char")
  expect_error({
    result <- .check_required_cols(required_tags = req_tags,
                                   vars_df = tmp_specs,
...
test_that(".check_required_cols errors for types", {
  ...
  req_tags <- c("project_id" = "char", "pcr_replicate" = "char",
                "tp_days" = "char")
  expect_error({
    result <- .check_required_cols(required_tags = req_tags,
                                   vars_df = tmp_specs,
...
test_that(".check_required_cols works as expected", {
  ...
  req_tags <- list("project_id" = "char", "pcr_replicate" = "int",
                   "tp_days" = c("char", "int"))
  result <- .check_required_cols(required_tags = req_tags,
                                 vars_df = tmp_specs,
                                 duplicate_politic = "keep")

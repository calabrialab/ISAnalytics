...
test_that(paste(func_name[2], "produces expected output"), {
  ...
  est_slice <- .re_agg_and_estimate(test_data, metadata = meta_with_lineage,
                                    ...
                                    cell_type = "MYELOID",
                                    tissue_type = "PB",
                                    annotation_cols = c("GeneName",
                                                        "GeneStrand"),
                                    subj_col = "SubjectID",
                                    stable_timepoints = c(9, 12, 13, 18, 30))
  expected <- tibble::tibble(Model = c('M0', 'Mh Chao (LB)', 'Mh Poisson2',
                                       'Mh Darroch', 'Mh Gamma3.5', 'M0',
                                       'Mh Chao (LB)', 'Mh Poisson2',
                                       'Mh Darroch', 'Mh Gamma3.5', 'M0',
                                       'M0', 'M0', 'M0', 'M0', 'Mth Chao (LB)',
                                       'Mth Chao (LB)'),
                             abundance = c(5121.04002304384, 5561.8125,
                                           ...
                                           5119.05887032526),
                             stderr = c(29.6524454059072, 59.5674353240835,
                             ...
                             CellType = c('Myeloid', 'Myeloid', 'Myeloid',
                                          ...
                                          'Myeloid', 'Myeloid', 'Myeloid',
                                          'Myeloid', 'Myeloid'),
                             Tissue = c('PB', 'PB', 'PB', 'PB', 'PB', 'PB',
                                        'PB', 'PB', 'PB', 'PB', 'PB', 'PB',
                                        'PB', 'PB', 'PB', 'PB', 'PB'),
                             TimePoint_from = c(6, 6, 6, 6, 6, 12, 12, 12,
                                                12, 12, 6, 12, 6, 12, 18, 6,
                                                12),
                             TimePoint_to = c(24, 24, 24, 24, 24, 24, 24, 24,

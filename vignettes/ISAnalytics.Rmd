...
bib <- c(
    ...
    ClonalTrackingPaper = BibEntry(bibtype = "Article", 
     title = paste("Efficient gene editing of human long-term hematopoietic", 
...
![NGS data explorer example](`r ngs_exp_fig`)

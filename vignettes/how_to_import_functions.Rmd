...
The functions both return a named list which names are the quantification types 
specified in input and the elements are integration matrices, obtained by 
binding rows of all imported matrices for the same quantification type.

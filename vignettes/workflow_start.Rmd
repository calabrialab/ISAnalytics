...
all_tags[, needed_in := purrr::map_chr(
    needed_in,
    ~ paste0(.x, collapse = ", ")
)]
mand_tags <- all_tags[
    eval(rlang::sym("dyn_vars_tbl")) == "mand_vars",
    mget(c("tag", "needed_in", "description"))
]
annot_tags <- all_tags[
    eval(rlang::sym("dyn_vars_tbl")) == "annot_vars",
    mget(c("tag", "needed_in", "description"))
]
af_tags <- all_tags[
    eval(rlang::sym("dyn_vars_tbl")) == "af_vars",
    mget(c("tag", "needed_in", "description"))
]
iss_tags <- all_tags[
    eval(rlang::sym("dyn_vars_tbl")) == "iss_vars",
    mget(c("tag", "needed_in", "description"))
]
```
